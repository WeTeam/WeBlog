...
namespace Sitecore.Modules.WeBlog.WebForms.Components.Parameters
{
    /// <summary>
    ...
    public class SublayoutParameterHelper : ParameterHelperBase<UserControl>
    {
        ...
        {
            BindingControl = control.Parent as Sublayout;
            ...
            Parameters = Web.WebUtil.ParseUrlParameters(BindingControl.Parameters);
