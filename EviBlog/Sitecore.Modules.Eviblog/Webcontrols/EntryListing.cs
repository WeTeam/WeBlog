...
namespace Sitecore.Modules.Eviblog.Webcontrols
{
	public class EntryListing : DataBoundControl, INamingContainer
	{
        ...
        {
            List<Item> entryList = GetEntries();
        ...
        private List<Item> GetEntries()
        {
            Item currentItem = Sitecore.Context.Item;
            List<Item> listEntries = new List<Item>();
            

            if (currentItem.TemplateID.ToString() == Settings.Default.CategoryTemplateID)
            {
