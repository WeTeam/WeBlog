...
<body>
    ...
    <fieldset id="general" title="General Settings">
        ...
        <asp:RequiredFieldValidator ID="rfvBlogEmail" runat="server" Text="*" ErrorMessage="Email" ControlToValidate="tbEmail" SetFocusOnError="true" EnableClientScript="true"></asp:RequiredFieldValidator>
